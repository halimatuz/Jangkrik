  ...
  <div class="content-wrapper">
    ...
    <div class="col-sm-2">
    <a href="<?php echo base_url()."index.php/C_LDP/TampilMasukanBackdate";?>"> <button  type="button" id="backdate" class="pull-right btn btn-default" id="sendEmail">Back Date</button>
 </a></div>
 </div>
...
<?php
foreach ($ldp as $row){
  $noSurat=explode('/',$row->nomor_ldp);
$NewSurat=implode('_',$noSurat);
echo'<tr><td style="text-align:center"><a href="'.base_url().'/index.php/C_LDP/TampilEditNoSurat/'.$NewSurat.'">
