          ...
          <div class="box box-info">
            ...
            <div class="box-body">
              ...
              <div class="col-sm-6">
                <div class="form-group">
                    ...
                    <div class="col-xs-9 selectContainer">
                        <select class="form-control" name="dari">
                            ...
                            <option value="d">Fungsi Pelaksanaan Pengembangan UMKM
                ...
                <div class="form-group">          
                    <div class="col-sm-9">
                              <select class="form-control" name="pilih_divisi" required>
                              <option value="" >Pilih Divisi</option>
                              <option value="h">Divisi Advisory Ekonomi Keuangan </option>
                              <option value="i">Divisi Pengembangan Ekonomi </option>
                              <option value="j">Divisi Sistem Pembayaran dan Pengelolaan Uang Rupiah</option>
                              </select>               
                    </div>
                 </div>
              </div>
