  ...
  <div class="content-wrapper">
    ...
    <div class="col-sm-2">
    <a href="<?php echo base_url()."index.php/C_Catatan/TampilMasukanBackdate";?>"> <button  type="button" id="backdate" class="pull-right btn btn-default" id="sendEmail">Back Date</button>
 </a></div>
 </div>
...
foreach ($catatan as $row){
  $noSurat=explode('/',$row->nomor_catatan);
$NewSurat=implode('_',$noSurat);
echo'<tr><td style="text-align:center"><a href="'.base_url().'/index.php/C_Catatan/TampilEditNoSurat/'.$NewSurat.'">
            <i class="fa fa-edit"></i>
          </a></td>
';
  echo '
<td>'.$row->nomor_catatan.'</td>
