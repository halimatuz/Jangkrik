                ...
                <h4>Tanggal Dinas Dilakukan :</h4>
                 ...
                 <div class="col-sm-4">
                   <div class="form-group">
                    ...
                    <div class="col-sm-9">
                    <input type="text" class="form-control" autocomplete="off" name="datefilter" value="<?php echo $mulai;?>" placeholder="" required>
                    </div>
                  </div>
                 </div>
                 <div class="col-sm-4">
                   <div class="form-group">
                    ...
                    <div class="col-sm-9">
                    <input type="text" class="form-control" autocomplete="off" id="datefilter2" name="datefilter2" value="<?php echo $akhir;?>" placeholder="" required>
                    </div>
                  </div>
                 </div>
                 </div>
